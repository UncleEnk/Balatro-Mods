...
local function updateCursors()
    ...
    cursorHover = getCursor("CursorHover", HOT_X, HOT_Y) --Modified "CursorHover" to "CursorHover"
    cursorDrag = getCursor("CursorHover", HOT_X, HOT_Y)  --Modified "CursorDrag" to "CursorHover"
